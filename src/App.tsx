            ...
            <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-8">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground text-xl">
                  Building the future of engineering at CSUSM through
                  innovation, community, and applied learning.
                </p>
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  where universities from across the country compete against
                  each other in a type of obstacle course. It is essentially a
                  race in which many rovers complete several tasks and are
                  awarded points based on efficiency.
                </p>
              </div>
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    ...
                    <p>
                      Alex Kwoka, Bob Semmer, & Coastal Community Foundation
                      were at full support with our ideas!
                    </p>
                  </li>
                  <li className="flex gap-3">
                    <div className="bg-primary flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full text-white">
                    ...
                    <p>
                      The team started developing a proof of concept to help
                      build up the team's skills and gauge capacity to prepare
                      for the URC.
                    </p>
                  </li>
                  <li className="flex gap-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <p>
                      After thorough review, the team decided to pivot our
                      project focus from the URC to an Autonomous Navigation
                      Golf Cart.
                    </p>
                  </li>
                </ul>
          ...
          <div className="container mx-auto w-full max-w-full px-4 md:max-w-7xl">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p>
                    ...
                    manufacturers and designers. This leads to delays and loss
                    of engagement for our team.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p>
                    ...
                    URC relies heavily on CAD & Manufacturing, instead we'll
                    focus on autonomous navigation, artificial intelligence,
                    distributed systems, electronics, and electrical systems
                    integration.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p>
                    Industry demand is high for the challenges we're focusing
                    on. Increasing the hireability of our students.
                    Additionally, we want the product of our efforts to impact
                    our campus directly rather than just receiving a ranking.
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                >
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <ArrowRight className="mt-0.5 h-5 w-5 flex-shrink-0 text-red-500" />
                      <span>
                        Mechanical blockers cause a high risk of losing
                        engagement
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
            ...
            <div className="bg-primary/5 mt-16 rounded-lg p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Establish the solidity of our team and open up marketing to
                    a wider community
                  </p>
                </li>
              </ul>
          ...
          <div className="container mx-auto w-full max-w-full px-4 md:max-w-7xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Orders already sent out for multiple projects, including:
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    SHPE will host and maintain engineering workshops adjoined
                    by industry sponsors and volunteers. Concepts include CAD
                    and PCB design. These will supplement our projects through
          ...
          <div className="container mx-auto w-full max-w-full px-4 md:max-w-7xl">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Integrate engineering faculty and administrators to bridge
                    the gap between coursework and engineering projects.
                  </p>
                </CardContent>
              </Card>
              <Card>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p>
                    We welcome students from all backgrounds who are interested
                    in engineering, robotics, programming, and innovation.
                  </p>
                  <ul className="space-y-2">
